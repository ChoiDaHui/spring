...
<div class="page_form">
		 <form role="form" action="/../../front/Writes" method="post">
          ...
          <div class="form-group">
            <label>Title</label><br> <input class="form-control" name='title'>
          </div>
			<br>
          <div class="form-group">
            <label>Text area</label><br>
            <textarea class="form-control" cols="80" rows="10" name='content'></textarea>
          </div>
			<br>
          <div class="form-group">
            <label>Writer</label><br> <input class="form-control" name='user_id' >
          </div>
          <br>
          <div class="form-group">
          ...
          <button type="reset" class="btn btn-default">이전으로</button>
        </form>
	</div>
	<div class="clear"></div>
</div>
