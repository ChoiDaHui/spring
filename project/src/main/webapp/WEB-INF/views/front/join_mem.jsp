...
<div class="page"><!-- 회원가입 폼 -->
            <div class="box_login">
                ...
                <br><button type="submit" class="btn" style="font-size: ">중복확인</button>
                <div class="inp_text">
               		비밀번호 
                <input type="text" id="loginId" name="loginId" >
                </div>
                ...
                <div class="inp_text">
                	 이메일 
                <input type="text" id="loginPw" name="email">
                </div>
                <br>
                <div class="inp_text">
                	 닉네임 
                <input type="text" id="loginPw" name="nickname">
                </div>
                <br>
                <div class="inp_text">
                	휴대 전화 
                <input type="text" id="loginPw" name="phone_num">
                </div>
                <br>
            </div>
            <br>
            <button type="submit" class="btn btn-3 btn-3e icon-arrow-center">회원가입</button>
